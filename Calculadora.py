...
class CalculadoraAvanzada:
    ...
    def crear_pantalla(self):
        ...
        self.pantalla.focus_set() # Enfocar la pantalla al iniciar
    ...
    def crear_botones(self):
        ...
        # CORRECCIÓN: Distribución simétrica de la última fila
        distribucion = [
        ...
        for texto, fila, col, tipo in distribucion:
            # El botón '=' en col 2 con colspan=2 ocupará la col 2 y 3 perfectamente.
    ...
    def vincular_teclado(self):
        """Permite usar el teclado físico interceptando el evento nativo"""
    ...
    def evento_teclado(self, evento):
        ...
        if tecla in "0123456789+-*/().":
            ...
            return "break"  # Evita que Tkinter vuelva a escribir el carácter en el Entry
